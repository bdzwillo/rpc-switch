...
fatal('undecodable json', -32700, qr/json decode failed/i,
...
# a response to a call that was never made is an invalid request
fatal('a stray response', -32600, qr/response for unknown call nosuchcall/,
	sub { $_[0]->send({jsonrpc => '2.0', id => 'nosuchcall', result => 42}) });
